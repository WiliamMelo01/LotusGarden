        ...
        <div class="cart-items-container">
            ...
            if (isset($_COOKIE['carrinho'])) {
                ...
                foreach ($carrinho as $item) {
                    ...
                    echo '
            <div class="cart-item">
                <a href="apagarItemCarrinho.php?idItemCarrinho=' . $item->getId() . '&&promocao=true" class="fas fa-times"></a>
...
';
    ...
    <section class="home home-cliente" home">
            ...
            foreach ($produtos as $produto) {
                echo ('
                    <div class="box">
                        ...
                        <a href="./adicionarCarrinho.php?idproduto=' . $produto['idProduto'] . '&&promocao=true" class="btn">adicionar ao carrinho</a>
                    </div>
                    ');
            }
            ?>
